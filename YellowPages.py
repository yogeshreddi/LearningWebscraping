...
class GetDetailsFromYp:
    ...
    def ScrapeYp(self):
        ...
        for link in soup.find_all("div",{"class":"info",}):
            ...
            try:
                business_address.append(link.contents[1].find_all("p",{"class":"adr"})[0].text.encode('utf-8').strip())
            except:
...
what = raw_input("What do you want to find\n")
where = raw_input("Please enter your current location, either zipcode or City, State. For Example 06105 or Hartford, CT\n")
